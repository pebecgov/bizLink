...
export function MediaGallerySection() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div>
                <h2 className="text-xl font-bold text-text-primary pb-4 border-b border-gray-100">Media Gallery</h2>
                <p className="text-sm text-gray-500 mt-2">Upload images and videos of your business</p>
            </div>
