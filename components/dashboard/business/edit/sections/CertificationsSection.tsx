...
export function CertificationsSection() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div>
                <h2 className="text-xl font-bold text-text-primary pb-4 border-b border-gray-100">Certifications & Awards</h2>
                <p className="text-sm text-gray-500 mt-2">Add your certifications and awards</p>
            </div>
            <div className="text-center py-12 text-gray-500">
                Certifications and awards management coming soon...
            </div>
